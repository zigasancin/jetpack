...
* A brand new VideoPress interface that seamlessly integrates with your media library.
* An exciting new SEO feature has been added to Jetpack to give you some new tools to optimize your website.
* Embed your favorite Pinterest content with this all new shortcode.
* We've improved the Jetpack connection notice to help users better understand the benefits of connecting their site to WordPress.com.
* You can now add a "My Community" widget to your sidebar showcasing your users who have recently interacted with your site.
* Enjoy the benefits of the Google Translation tool in a new Jetpack widget.

**Enhancements**
* We've made it easier to address Akismet issues and update plugins.
* Look for helpful hints from Jetpack throughout the admin.
* The Jetpack Development Mode banner and interface got a design refresh.
* We've sped up the Jetpack admin a bit by using SVGs instead of raster images.
* We took sometime to improve color contrast in the Jetpack admin for better accessibility.
* Jetpack custom post types have been added to the output of the WordPress REST API.
